...
/**
 * Get indicator string for a status.
 * Unlike STATUS_ICONS, always returns something
 * when seamless is running (idle = "S").
 * @param {string} status - Status from resolveStatus
 * @returns {string} Indicator character or emoji
 */
export function indicator(status) {
  return STATUS_INDICATORS[status] || 'S'
}

export { STATUS_ICONS, STATUS_INDICATORS }
